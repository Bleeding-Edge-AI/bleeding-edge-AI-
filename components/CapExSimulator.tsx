    ...
    return (
        <section className="py-24 px-6 bg-neutral-950 border-t border-white/5 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                {/* Animation Canvas Wrapper for Mobile Scroll */}
                <div className="w-full overflow-x-auto pb-4">
                    <div className="relative h-[400px] w-full min-w-[800px] max-w-[1000px] mx-auto bg-neutral-900/20 rounded-3xl border border-white/5 overflow-hidden">
